...
//		}
//	}
	public void DeckWrite(List<string> _Deck)
	{
		using (var writer = new CsvFileWriter("Assets/Resources/Deck.csv"))
		{
			List<string> columns = new List<string>(){"Name"};// making Index Row
			writer.WriteRow(columns);
			columns.Clear();
